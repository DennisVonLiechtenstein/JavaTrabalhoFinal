...
public class CadConta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 170, 70, -1));
        ...
        getContentPane().add(btvalor, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 170, 70, -1));

        paraconta.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        getContentPane().add(paraconta, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 190, 90, 20));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel9.setText(" Conta Destino ");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, 80, -1));
        ...
        getContentPane().add(deconta, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 160, 90, 20));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel7.setText(" Conta  ");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 160, 70, -1));

        transfere.setBackground(new java.awt.Color(153, 255, 255));
        transfere.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        transfere.setForeground(new java.awt.Color(0, 0, 0));
        transfere.setText("Transferi");
        transfere.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                transfereActionPerformed(evt);
            }
        });
        getContentPane().add(transfere, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, -1, -1));
